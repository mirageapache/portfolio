        ...
        <div className="content_div">
          <div className="grid_div">
            ...
            <div className="content">
              ...
              <p>
                畢業後並雖然沒有如願在軟體相關的領域，即便投筆從戎成為職業軍人但仍懷抱著工程師的夢想，因此役期屆滿時退伍轉而朝向工程師的職涯前進。
                退伍後參加Alpha
                Camp全端網路開發課程，學會ReactJS前端框架的開發。
              </p>
              <p>
                現任為東南旅遊前端工程師，已從初階邁向中階工程師，但還是時刻提醒自己持續學習各項前後端技術，期望有朝一日成為頂尖的全端工程師！
              </p>
            </div>
          </div>
        </div>
